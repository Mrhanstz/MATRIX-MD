...
BOT_NAME: process.env.BOT_NAME || "『 MATRIX 𝐌𝐃 』",
// Enter Your Bot Name
...
DESCRIPTION: process.env.DESCRIPTION || "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ Mᴀᴛʀɪx-Xᴍᴅ*",
// add bot owner name   
 
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/9N1sJ41/Manul-Ofc-X.jpg",
// add img for alive msg

LIVE_MSG: process.env.LIVE_MSG || ">  Mᴀᴛʀɪx-Xᴍᴅ ɪs ᴏɴʟɪɴᴇ*⚡",
// add alive msg here 
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS__MSG || "* Hi there, MATRIX-XMD viewed your Status🎐*",
